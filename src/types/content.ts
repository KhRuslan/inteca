...
export const defaultContent: SiteContent = {
  ...
  keyBenefits: [
    { label: 'Strategic Thinking', percentage: 30, color: '#DC2626' },
    { label: 'Complex Problem Analysis', percentage: 25, color: '#6B7280' },
    { label: 'Confidence in management decision', percentage: 20, color: '#9CA3AF' },
    { label: 'Argumentation Skills', percentage: 15, color: '#9CA3AF' },
    { label: 'Team Collaboration', percentage: 10, color: '#D1D5DB' }
  ],
  founder: {
  ...
  founderPage: {
    ...
    internationalCertificates: {
      ...
      conclusion: 'Такой сертификат подтверждает обучение с использованием оригинальных материалов Harvard Business School и имеет высокий международный вес.'
    },
