...
export interface PreMBAProgram {
  title: string
  subtitle: string
  description: string
  participants: string
...
export interface TeacherRoleStep {
  title: string
  description: string
}

export interface TeacherRoleInCaseLearning {
  title: string
  introduction: string
  steps: TeacherRoleStep[]
}

export interface InternationalCertificates {
  title: string
  subtitle: string
  description: string
...
export interface FounderPageContent {
  ...
  cards: FounderCard[]
  teacherRoleInCaseLearning?: TeacherRoleInCaseLearning
  internationalCertificates?: InternationalCertificates
  preMBAProgram?: PreMBAProgram
...
export interface EnglishDevelopmentContent {
  title: string
  subtitle: string
  introduction: string
...
export interface MethodologyCase {
  ...
  keyFacts?: string[]
  callToAction?: string
  fullContent?: EnglishDevelopmentContent
}
...
export const defaultContent: SiteContent = {
  ...
  caseBasedLearning: {
    ...
    link1Text: 'Узнайте больше о том, как работает кейс-обучение',
    link2Text: 'Изучите нашу полную методологию',
  ...
  keyBenefits: [
    { label: 'Стратегическое мышление', percentage: 30, color: '#DC2626' },
    { label: 'Анализ сложных проблем', percentage: 25, color: '#6B7280' },
    { label: 'Уверенность в управленческих решениях', percentage: 20, color: '#9CA3AF' },
    { label: 'Навыки аргументации', percentage: 15, color: '#9CA3AF' },
    { label: 'Командное сотрудничество', percentage: 10, color: '#D1D5DB' }
  ],
  founder: {
    title: 'Основатель — Олег Цой',
  ...
  about: {
    hero: {
      title: 'О программе',
      description: 'InTECA — это академическая программа, построенная на Гарвардском кейс-методе — ведущем мировом подходе к развитию аналитических и лидерских навыков через реальные бизнес-сценарии.',
      formula: 'Ситуация → Анализ → Обсуждение → Решение → Рефлексия',
      image: '/about1.jpeg'
    },
    ...
    formatButtonText: 'Выберите ваш формат',
    formatFooterText: 'Все форматы нацелены на результат: освоение кейс-метода.',
    afterCompleting: {
      ...
      buttonText: 'Подать заявку на программу',
      image: '/about2.jpeg'
    },
    ...
    coreCompetencies: [
      ...
      },
      {
        ...
        linkText: 'Посмотреть преимущества'
      },
      {
  ...
  founderPage: {
    ...
    practitionerDescription: 'Преподаватель имеет официальную лицензию на преподавание и дистрибуцию кейсов, право проводить обучение в соответствии со стандартами HBS, право формировать и выдавать сертификаты установленного образца.',
    preMBAProgram: {
      title: 'PreMBA "Real Estate Development" — единственная программа в Казахстане',
      subtitle: 'Путь преподавателя в образовании',
      description: 'Пять лет назад была создана первая и единственная в Казахстане программа PreMBA "Real Estate Development", рассчитанная на развитие управленческих компетенций в девелопменте и недвижимости.',
      participants: 'Программу прошло более 120 человек.',
      role: 'Преподаватель является разработчиком программы и её директором с момента запуска.',
      disciplinesTitle: 'Он лично ведёт три ключевые дисциплины:',
      disciplines: [
        'Эмоциональный интеллект',
        'Фондовые рынки',
        'Лидерство'
      ],
      conclusion: 'Эта программа стала уникальным мостом между практическим девелопментом, управленческим образованием и международными методиками обучения.'
    },
    cards: [
      {
      ...
      },
      {
        ...
        description: 'Наш преподаватель является выпускником двух ведущих бизнес-школ мира и прошёл обучение более чем по 250 кейсам, включая 140+ кейсов Harvard Business School, 100+ кейсов London Business School, десятки дополнительных современных кейсов по стратегии, финансам, лидерству, экономике и управлению. Этот опыт обеспечивает глубокий взгляд на разные отрасли, бизнес-модели, управленческие подходы и международные практики.',
        linkText: 'Узнать больше'
      },
      {
    ...
    internationalCertificates: {
      title: 'Статус преподавателя Harvard Business Publishing Education',
      subtitle: 'Право выдачи международных сертификатов',
      description: 'Каждый слушатель, успешно прошедший программу, может получить сертификат с официально разрешённой надписью:',
      certificateText: 'This certifies that [Student Name] has successfully completed an intensive case analysis program featuring Harvard Business School case studies licensed through Harvard Business Publishing. Guided by Oleg Tsoy, a Registered & Certified Harvard Business Publishing Educator.',
      certificationNote: 'Такой сертификат подтверждает обучение с использованием оригинальных материалов Harvard Business School и имеет высокий международный вес.',
      conclusion: ''
    },
    teacherRoleInCaseLearning: {
      title: 'Роль преподавателя в кейс обучении',
      introduction: 'Эффективное кейс-обучение во многом зависит от преподавателя. Он выступает не просто лектором, а практиком и модератором, который направляет группу, но не доминирует в обсуждении.',
      steps: [
        {
          title: '1. Определение уровня группы',
          description: 'На первом этапе преподаватель оценивает каждого слушателя:\nвозраст,\nуправленческий и профессиональный опыт,\nтекущую должность,\nобразование и специализацию,\nуровень английского языка (если кейсы в оригинале).\nЭто позволяет подобрать кейсы, которые будут одновременно посильными и развивающими.'
        },
        {
          title: '2. Подбор кейсов',
          description: 'Преподаватель формирует серию кейсов:\nкороткие кейсы (до 6 страниц) — для быстрого анализа,\nполные кейсы (до 30 страниц) — для глубоких стратегических обсуждений.\nТемы подбираются под уровень группы и реальные ситуации, которые слушатели могут встретить в своей работе.'
        },
        {
          title: '4. Работа в классе',
          description: 'Во время обсуждения преподаватель:\nучитывает, кто как подготовился до занятия,\nмотивирует пассивных участников,\nподдерживает более скромных,\nкорректирует чрезмерно активных,\nнаправляет дискуссию в правильное русло.\nТакже преподаватель заранее формирует рабочие группы и меняет их состав от кейса к кейсу, чтобы слушатели учились взаимодействовать с разными людьми и стилями мышления.'
        },
        {
          title: '5. Навигация обсуждения',
          description: 'Роль преподавателя включает:\nумение слушать,\nзадавать точные вопросы,\nотвечать на вопросы группы,\nпояснять факты, контекст и ключевые цифры,\nделиться релевантной статистикой и практическим опытом.'
        },
        {
          title: '6. Завершение и практическое применение',
          description: 'В финале занятия преподаватель помогает группе сформулировать:\nкакие выводы сделаны,\nкак применять знания в работе,\nкак использовать полученные навыки в собственном развитии,\nкак выстраивать себя как личную Экосистему — ценного специалиста для компании, партнёров и рынка.'
        }
      ]
    },
    biography: {
  ...
  methodologyPage: {
    ...
    benefits: [
      ...
      {
        title: 'Глобальное → Локальное',
        description: 'Думай глобально — действуй локально. Эта фраза часто звучит в ведущих бизнес-школах мира. Она означает, что хороший руководитель должен уметь смотреть на ситуацию шире, чем рамки своей компании или даже своей страны.',
        structuredContent: {
          sections: [
            {
              title: 'Что значит "думать глобально" простыми словами?',
              content: 'Это означает:',
              items: [
                'понимать, как работает бизнес в мире,',
                'видеть, какие тенденции формируют глобальную экономику,',
                'знать, как действуют крупнейшие компании,',
                'уметь объяснить, почему тот или иной тренд появляется и куда он ведёт,',
                'разбираться, почему глобальные холдинги принимают определённые решения.'
              ],
              subsections: [
                {
                  content: 'Глобальное мышление — это способность увидеть картину целиком: от мировых рынков и геополитики до технологий, управления людьми и корпоративной культуры.'
                },
                {
                  title: 'Почему это важно обычному человеку?',
                  content: 'Потому что мир меняется быстро, и те, кто понимает общие тенденции, быстрее адаптируются и зарабатывают больше.'
                },
                {
                  content: 'Простой пример: Если человек знает, как работают международные компании, он может перенести эти подходы в свою работу — даже если он работает в небольшой фирме или государственном учреждении.',
                  emphasis: true
                }
              ]
            },
            {
              title: 'А что значит "действовать локально"?',
              content: 'Это способность брать лучшие мировые практики и применять их здесь и сейчас, в условиях нашего рынка и наших правил игры.',
              subsections: [
                {
                  content: 'Это означает:',
                  items: [
                    'адаптировать глобальные идеи под местные реалии,',
                    'учитывать культуру, законодательство, менталитет, ресурсы,',
                    'использовать международные подходы в собственной команде,',
                    'применять полученные знания в повседневных рабочих ситуациях.'
                  ]
                }
              ]
            },
            {
              title: 'Как это работает для каждого человека',
              content: 'Лидер, который думает глобально, но действует локально:',
              items: [
                'эффективнее решает сложные задачи,',
                'быстрее находит новые возможности,',
                'лучше понимает конкурентов и клиентов,',
                'становится интереснее для своей компании как специалист,',
                'растёт профессионально значительно быстрее.'
              ],
              subsections: [
                {
                  content: 'Фактически человек начинает развивать себя по логике международных конгломератов — только в масштабе своей карьеры.'
                },
                {
                  content: 'Это похоже на создание своей личной экосистемы компетенций, когда навыки, знания, опыт, круг общения и личная стратегия развития соединяются в единую сильную структуру.',
                  emphasis: true
                }
              ]
            },
            {
              ...
              content: 'Потому что глобальное мышление расширяет горизонты, а локальные действия делают результат реальным и осязаемым. Если думать широко и действовать предметно, можно добиться большего практически в любой сфере.'
            }
          ]
        }
      }
    ],
    casesTitle: 'Методология и кейсы',
    cases: [
      {
        title: 'Маркетинг',
        description: 'Использование кейсов Harvard Business School помогает маркетинговым программам привлекать более сильных кандидатов и укреплять международную репутацию.',
        linkText: 'Подробнее',
        detailedDescription: 'Кейсы HBS привносят глобальные маркетинговые сценарии непосредственно в аудиторию — от поведения потребителей и брендовой стратегии до выхода на рынок и конкурентного позиционирования. Студенты анализируют реальные ситуации, защищают решения и практикуют структурированные обсуждения. Это развивает стратегическое мышление и придает программам более сильный международный профиль, поддерживаемый оригинальными материалами от Harvard Business Publishing Education.',
        keyFacts: [
          'Поддерживает сильное глобальное позиционирование',
          'Повышает академическую репутацию',
          'Привлекает высокопотенциальных студентов'
        ],
        callToAction: 'Кейсы HBS привносят глобальные маркетинговые сценарии в аудиторию, делая программы более конкурентоспособными и практико-ориентированными.'
      },
      {
        title: 'Экономика',
        description: 'Включение кейсов HBS помогает программам по экономике соответствовать стандартам AACSB, AMBA и EQUIS, одновременно укрепляя глобальное признание.',
        linkText: 'Подробнее',
        detailedDescription: 'Кейсы Harvard Business School знакомят студентов с макроэкономической политикой, рыночной динамикой, торговыми переговорами и регуляторными решениями. Они связывают теорию с реальными результатами и обучают студентов критически мыслить об экономическом воздействии. Это укрепляет качество программы и помогает соответствовать международным стандартам аккредитации.',
        keyFacts: [
          'Соответствует стандартам AACSB, AMBA и EQUIS',
          'Укрепляет глобальное признание программы',
          'Связывает теорию с реальным применением'
        ],
        callToAction: 'Включение кейсов HBS помогает программам по экономике соответствовать глобальным стандартам аккредитации.'
      },
      {
        title: 'Стратегия',
        description: 'Программы по стратегии получают преимущества от кейсов HBS, привлекая лучших кандидатов и повышая глобальную репутацию учреждения.',
        linkText: 'Подробнее',
        detailedDescription: 'Стратегические кейсы от Harvard Business School погружают студентов в конкурентное позиционирование, корпоративные преобразования, выход на рынок и управление портфелем. Студенты учатся оценивать компромиссы, строить фреймворки и защищать стратегические решения — развивая аналитическую строгость, ожидаемую в программах высшего уровня.',
        keyFacts: [
          'Привлекает высококвалифицированных кандидатов',
          'Повышает глобальную репутацию',
          'Формирует фреймворки стратегического мышления'
        ],
        callToAction: 'Программы по стратегии получают преимущества от кейсов HBS, привлекая лучших кандидатов и повышая глобальную репутацию.'
      },
      {
        title: 'Финансы',
        description: 'Финансовые программы, использующие кейсы HBS, устанавливают высокие академические стандарты и лучше готовят студентов к высокодостижимым позициям.',
        linkText: 'Подробнее',
        detailedDescription: 'Финансовые кейсы HBS охватывают распределение капитала, оценку стоимости, управление рисками, M&A и принятие финансовых решений в условиях неопределенности. Студенты практикуют реальный финансовый анализ и укрепляют уверенность в обсуждениях высоких ставок — готовя их к требовательным ролям в банковском деле, консалтинге и корпоративных финансах.',
        keyFacts: [
          'Устанавливает высокие академические стандарты',
          'Готовит к требовательным финансовым ролям',
          'Охватывает оценку, M&A и управление рисками'
        ],
        callToAction: 'Финансовые программы, использующие кейсы HBS, устанавливают высокие академические стандарты и готовят студентов к высокодостижимым ролям.'
      },
      {
        title: 'Лидерство',
        description: 'Программы по лидерству получают преимущества от кейсов HBS, привлекая мотивированных студентов и повышая академический статус учреждения.',
        linkText: 'Подробнее',
        detailedDescription: 'Кейсы по лидерству от Harvard знакомят студентов с этическими дилеммами, командными конфликтами, антикризисным управлением и организационными изменениями. Они практикуют принятие решений в неоднозначных ситуациях и развивают коммуникационные навыки, необходимые для вдохновения команд и достижения результатов.',
        keyFacts: [
          'Привлекает мотивированных и высокопотенциальных студентов',
          'Повышает институциональный статус',
          'Развивает навыки антикризисного управления и управления изменениями'
        ],
        callToAction: 'Программы по лидерству получают преимущества от кейсов HBS, привлекая мотивированных студентов и повышая академический статус.'
      },
      {
        title: 'Продажи',
        description: 'Использование кейсов HBS повышает глобальную репутацию программ по продажам и формирует более всесторонне развитых, высокопотенциальных учащихся.',
        linkText: 'Подробнее',
        detailedDescription: 'Кейсы HBS по продажам привносят в аудиторию динамику переговоров, управление взаимоотношениями с клиентами, ценовую стратегию и оптимизацию воронки продаж. Студенты практикуют реальные клиентские сценарии, учатся работать с возражениями и строят фреймворки для консультативных продаж.',
        keyFacts: [
          'Повышает репутацию программы',
          'Формирует всесторонне развитых профессионалов в продажах',
          'Обучает переговорам и консультативным продажам'
        ],
        callToAction: 'Использование кейсов HBS повышает глобальную репутацию программ по продажам и формирует более всесторонне развитых учащихся.'
      },
      {
        title: 'Управление человеческими ресурсами (HR)',
        description: 'Кейсы Harvard Business School знакомят студентов с реальными HR-вызовами — от управления талантами и организационной культуры до систем эффективности и лидерской динамики. Они помогают университетам строить современную, практико-ориентированную HR-программу, соответствующую глобальным стандартам и готовящую студентов к реальному управленческому принятию решений. В результате программа становится более конкурентоспособной, более привлекательной для кандидатов и лучше соответствует международным академическим стандартам.',
        linkText: 'Подробнее',
        detailedDescription: 'Кейсы Harvard Business School знакомят студентов с реальными HR-вызовами — от управления талантами и организационной культуры до систем эффективности и лидерской динамики. Они помогают университетам строить современную, практико-ориентированную HR-программу, соответствующую глобальным стандартам и готовящую студентов к реальному управленческому принятию решений.',
        keyFacts: [
          'Охватывает управление талантами и организационную культуру',
          'Формирует практико-ориентированную HR-программу',
          'Соответствует глобальным HR-стандартам',
          'Готовит к реальным управленческим решениям'
        ],
        callToAction: 'В результате программа становится более конкурентоспособной, более привлекательной для кандидатов и лучше соответствует международным академическим стандартам.'
      },
      {
        title: 'Развитие английского через кейсы',
        description: 'Естественное развитие английского языка через кейсы HBPE с английски-дружественным подходом для групп со смешанным уровнем владения. Каждое занятие добавляет бизнес-лексику из оригинальных кейсов, поддержку глоссария и опциональную командную практику на Duolingo.',
        linkText: 'Подробнее',
        detailedDescription: 'Помимо изучения кейсов и практических бизнес-навыков, наши занятия включают мягкий, английски-дружественный подход, разработанный для слушателей с разным уровнем владения. Студенты расширяют словарный запас через оригинальные кейсы Harvard Business Publishing Education, используют его в обсуждениях по желанию и практикуются в поддерживающей среде.',
        keyFacts: [
          'Бизнес-лексика из реальных кейсов Harvard на каждом занятии',
          'Специальный глоссарий для каждого кейса для естественного закрепления новых терминов',
          'Опциональная групповая практика на Duolingo с легким соревнованием и взаимной поддержкой',
          'Не формальный курс английского, но дает реальную уверенность и убирает языковой барьер'
        ],
        callToAction: 'Кейс-обучение дает естественный стимул для улучшения английского при освоении реальных бизнес-решений.',
        fullContent: {
          title: 'Естественное развитие английского языка через работу с кейсами HBPE',
          subtitle: '',
          introduction: 'Помимо изучения кейсов и получения практических бизнес-навыков, наши занятия включают специальный English-friendly approach — мягкое, ненавязчивое и интересное развитие английского языка, ориентированное на слушателей с разным уровнем владения.',
          howItWorksTitle: 'Как это работает',
          howItWorks: [
            {
              title: '1. Изучение бизнес-лексики через реальные кейсы',
              description: 'На каждом занятии слушатели знакомятся с современными английскими бизнес-терминами и выражениями, которые встречаются в оригинальных кейсах Harvard Business Publishing Education (HBPE). Использование терминов происходит по желанию слушателей — в обсуждениях, групповых дискуссиях и анализе ситуаций.'
            },
            {
              title: '2. Глоссарий к каждому занятию',
              description: 'Преподаватель готовит индивидуальный глоссарий ключевых терминов к каждому кейсу. Слушатели практикуют лексику в течение занятия, что позволяет естественно закреплять новые слова без формального изучения языка.'
            },
            {
              title: '3. Дополнительная практика на платформе Duolingo',
              description: 'По запросу группы преподаватель может создать групповую студенческую команду на Duolingo, где каждый участник проходит задания в личном темпе, но в общей атмосфере:\nлёгкой состязательности,\nгрупповой поддержки,\nсовместного прогресса.\nЭто помогает сохранить мотивацию и развить привычку к регулярной языковой практике.'
            }
          ],
          whyEffectiveTitle: 'Почему это эффективно',
          whyEffective: [
            'Занятия не создают ощущения «курса английского языка», но при этом дают реальное улучшение навыков.',
            'Многие слушатели хотят говорить на английском, но им не хватает стимула — работа с кейсами даёт его естественным образом.',
            'Изучая оригинальные материалы HBPE, слушатели перебарывают языковой барьер, становятся увереннее и свободнее в использовании английского в профессиональном контексте.'
          ]
        }
      }
    ]
  ...
  forUniversitiesPage: {
    ...
    additionalBenefitsTitle: 'Дополнительные преимущества',
    additionalBenefits: [
      {
        title: 'Опытный преподаватель',
        description: 'Университет получает преподавателя, прошедшего обучение в HBS и LBS, со значительным практическим опытом.'
      },
      {
        title: 'Уникальная образовательная среда',
        description: 'Формируется уникальная образовательная среда, которая повышает конкурентоспособность программ.'
      },
      {
        title: 'Улучшение качества обучения',
        description: 'Внедрение кейсов улучшает качество обучения и удовлетворенность студентов.'
      }
    ],
    benefits: [
      {
    ...
    integrationFormats: [
      {
        title: 'Корпоративные тренинги — однодневные и двухдневные',
        bestFor: 'Best for:',
        bestForText: 'Интенсивные форматы для быстрого развития навыков и подготовки команд к новым задачам.',
        description: 'Это интенсивные форматы, которые включают разбор до 6 кейсов за один уикенд.',
        howUsed: {
      ...
      },
      {
        title: 'Модульные программы',
        bestFor: 'Best for:',
        bestForText: 'Сбалансированный формат для длительного развития навыков.',
        description: 'Серия занятий, проходящая раз в неделю или несколько раз в месяц. Это наиболее сбалансированный и продуктивный формат.',
        themes: {
      ...
      },
      {
        title: 'Интеграция в программы MBA',
        bestFor: 'Best for:',
        bestForText: 'Университеты, стремящиеся внедрить международные стандарты обучения и расширить образовательные возможности для студентов.',
        description: 'Гибкое решение для интеграции кейс-метода в существующие образовательные программы без дополнительной нагрузки на преподавательский состав.',
        integration: {
    ...
    cta: {
      ...
      buttonText: 'Свяжитесь с нами для индивидуального предложения →'
    }
  },
  forStudentsPage: {
    hero: {
      ...
      whatYouGainTitle: 'Что вы получите от программы'
    },
    whatYouGain: {
      intro: 'Вместо заучивания теории, студенты учатся:',
      list: [
        'анализировать сложные ситуации,',
        'принимать решения в условиях неопределенности,',
        'видеть причинно-следственные связи,',
        'защищать свою позицию аргументами,',
        'понимать, как мыслят и действуют лидеры.'
      ],
      conclusion: 'Обучение становится практичным, увлекательным и непосредственно применимым к будущей карьере.'
    },
    skillsTitle: 'Навыки, которые вы разовьете',
    whatEducationGives: {
      title: 'Что даёт такое образование студентам и компаниям',
      points: [
        'глубокое понимание бизнеса с разных сторон — права, экономики, стратегии и управления;',
    ...
    skills: [
      {
        title: 'Стратегическое мышление',
        description: 'Способность видеть общую картину, оценивать множество вариантов и понимать долгосрочные последствия.'
      },
      {
        title: 'Аналитические навыки',
        description: 'Разбор сложных проблем, работа с данными, фактами и предположениями.'
      },
      {
        title: 'Уверенность в принятии решений',
        description: 'Практика управленческих решений в безопасной учебной среде.'
      },
      {
        title: 'Аргументация',
        description: 'Изучение того, как четко выражать идеи, защищать мнения и участвовать в профессиональных дискуссиях.'
      },
      {
        title: 'Сотрудничество',
        description: 'Работа в меняющихся группах и обучение взаимодействию с различными стилями мышления.'
      },
      {
        title: 'Глобальное мышление',
        description: 'Понимание того, как работают международные компании и как применять глобальные практики локально.'
      }
    ],
    caseLearningPath: {
      ...
      marketValueDescription: 'Человек, идущий по Case Learning Path, становится всё более востребованным на рынке. Его воспринимают как профессионала, который инвестирует в себя и непрерывно расширяет свои компетенции.',
      additionalBenefitsTitle: 'Дополнительные преимущества Case Learning Path',
      benefits: [
        {
    ...
    certificates: {
      title: 'Сертификаты',
      description1: 'Студенты, успешно завершившие программу, могут получить официальный сертификат, подтверждающий участие в программе анализа кейсов на основе лицензированных материалов Harvard Business School.',
      description2: 'Каждый участник также получает персонализированную кейс-книгу (Case Book), содержащую изученные во время программы кейсы.',
      image: '/for-students2.jpeg'
    },
    faqTitle: 'Часто задаваемые вопросы',
    faq: [
      {
        question: 'Нужен ли высокий уровень английского?',
        answer: 'Нет. Программа разработана для студентов с разным уровнем английского. Развитие английского происходит постепенно и естественно.'
      },
      {
        question: 'Это курс английского языка?',
        answer: 'Нет. Английский улучшается в результате работы с реальными материалами, но фокус — бизнес-мышление и принятие решений.'
      },
      {
        question: 'Кейсы реальные?',
        answer: 'Да. Все кейсы — это реальные бизнес-ситуации, официально лицензированные через Harvard Business Publishing Education.'
      },
      {
        question: 'Поможет ли это моей будущей карьере?',
        answer: 'Да. Кейс-обучение развивает навыки, высоко ценимые работодателями: мышление, суждение, коммуникацию и лидерский потенциал.'
      },
      {
        question: 'Это похоже на обучение в стиле MBA?',
        answer: 'Да. Подход к обучению основан на той же методологии, используемой в ведущих мировых бизнес-школах, адаптированной для студентов.'
      }
    ],
    cta: {
      buttonText: 'Подать заявку'
  ...
  forCorporateClientsPage: {
    ...
    trainingFormats: [
      {
        ...
        description: 'Мы создаём учебную программу, учитывая специфику вашей отрасли, уровень сотрудников, стратегические задачи бизнеса, корпоративную культуру, требования руководства. Курс формируется так же, как в ведущих бизнес-школах, но адаптируется под реалии вашей компании.',
      ...
      },
      {
        ...
        description: 'Корпоративное обучение на основе кейсов приносит значительные преимущества для развития бизнеса и команды.',
      ...
      },
      {
        ...
        description: 'В отличие от зарубежных программ, обучение проходит в формате, встроенном в рабочий график. Это особенно важно для компаний, где ключевые люди всегда должны быть на месте.',
      ...
      },
      {
        ...
        description: 'Мы формируем подборку кейсов не ранее 2020 года, чтобы обучение отражало реальную динамику современного мира. Работа с кейсами поддерживает мозг в режиме постоянного анализа и формирует глобальное управленческое мышление.',
      ...
      },
      {
        ...
        description: 'Кейсы расширяют кругозор, учат ставить долгосрочные цели и выстраивать стратегию развития — как в карьере, так и в жизни.',
    ...
    sampleCasesTitle: 'Что именно развивает CLP',
    sampleCases: [
      {
        title: '',
        description: 'Изучая кейсы по ключевым направлениям:\nмаркетинг,\nэкономика,\nстратегия,\nфинансы,\nлидерство,\nпродажи,\nуправление персоналом (HR),\n— вы поддерживаете мозг в состоянии постоянного анализа и формируете глобальное управленческое мышление.\nЭто похоже на регулярные тренировки для лидеров: каждый кейс — это новая ситуация, новый вызов и новое управленческое решение.'
      }
    ],
    ...
    businessResults: [
      {
        ...
        metrics: [
          { value: 'Расширенное', label: 'Стратегическое видение', sub: 'Улучшение долгосрочного мышления' },
          { value: 'Повышенное', label: 'Качество решений', sub: 'Лучшее соответствие целям' }
        ]
      },
      {
        ...
        metrics: [
          { value: 'Укреплённая', label: 'Уверенность', sub: 'В принятии решений' },
          { value: 'Улучшенная', label: 'Оценка рисков', sub: 'Улучшение навыков анализа' }
        ]
      },
      {
        title: 'Лидерство',
        ...
        metrics: [
          { value: 'Активное', label: 'Вовлечение команды', sub: 'Улучшение сотрудничества' },
          { value: 'Сниженное', label: 'Снижение ошибок', sub: 'Меньше стратегических ошибок' }
        ]
      }
    ],
    faqTitle: 'Часто задаваемые вопросы',
